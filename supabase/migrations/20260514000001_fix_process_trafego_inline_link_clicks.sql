-- Atualiza process_trafego para usar inline_link_clicks (cliques no link)
-- em vez de clicks (todos os cliques). Mantém clicks como fallback para
-- dados históricos já gravados em raw_trafego antes desta migração.
...
BEGIN
  ...
  -- Com ad_id: verificar duplicata da Meta (mesmo ad_id + date já existe)
