-- Padrão "last non-null/non-zero wins":
-- Sempre atualiza todos os campos, mas se o novo valor vier zerado ou vazio,
-- mantém o último valor preenchido. Resolve o caso da Guru que envia dois
-- eventos approved: o primeiro com marketplace_value=0 e net=total (errado),
-- o segundo com os valores corretos.
